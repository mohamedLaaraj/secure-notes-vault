    ...
    public function run(): void
    {
        $challenges = [
            ...
            [
                ...
                'difficulty'  => 'easy',
                'points'      => 100,
                'flag'        => 'FLAG{caesar_cipher_is_broken}',
                'hint'        => 'Caesar used a shift of 3. The flag format is FLAG{...}',
            ],
            [
            ...
            [
                ...
                'difficulty'  => 'hard',
                'points'      => 500,
                'flag'        => 'FLAG{vigenere_not_too_safe}',
                'hint'        => 'Research: who is the most famous French hacker in history?',
            ],
            [
                'title'       => 'RSA Baby Steps',
                'description' => 'Given: p=61, q=53, e=17, ciphertext=2790. Find the plaintext and convert it to ASCII. The flag is FLAG{ASCII_character}.',
                'category'    => 'crypto',
                'difficulty'  => 'hard',
                'points'      => 500,
                'flag'        => 'FLAG{A}',
            ...
            [
                ...
                'description' => 'A photo was taken at a secret location. The photographer forgot to strip the metadata. Download the image and find where it was taken. The flag is FLAG{city_country} in lowercase.',
                'category'    => 'forensics',
                'difficulty'  => 'easy',
                'points'      => 100,
                'flag'        => 'FLAG{agadir_morocco}',
            ...
            [
                ...
                'difficulty'  => 'hard',
                'points'      => 500,
                'flag'        => 'FLAG{deleted_files_speak_volumes}',
            ...
            [
                ...
                'description' => 'This Python bytecode hides a flag. Decompile it and find out what the program would print. Submit the output as FLAG{output}.',
                'category'    => 'reverse',
                'difficulty'  => 'medium',
                'points'      => 250,
            ...
            [
                ...
                'description' => 'This x86 assembly function checks a password. Figure out what the correct password is. The flag is FLAG{the_password}.',
                'category'    => 'reverse',
                'difficulty'  => 'hard',
                'points'      => 500,
                'flag'        => 'FLAG{asm_is_fun_not}',
            ...
            [
                ...
                'description' => 'A developer posted their project on GitHub. Their username contains the word "cipher". Find their oldest repository and submit the flag hidden in the README as FLAG{...}.',
                'category'    => 'osint',
                'difficulty'  => 'easy',
                'points'      => 100,
                'flag'        => 'FLAG{github_is_an_open_book}',
            ...
            [
                ...
                'difficulty'  => 'medium',
                'points'      => 250,
                'flag'        => 'FLAG{the_internet_never_forgets}',
            ...
            [
                ...
                'difficulty'  => 'easy',
                'points'      => 100,
                'flag'        => 'FLAG{morse_code_lives_on}',
                'hint'        => 'Each letter is separated by a space, each word by a /. Use an online Morse decoder.',
            ],
            [
                'title'       => 'QR Code Challenge',
                'description' => 'This QR code has been deliberately corrupted. 3 blocks are wrong. Fix it and scan it to get the flag. The flag format is FLAG{...}.',
                'category'    => 'misc',
                'difficulty'  => 'hard',
                'points'      => 500,
                'flag'        => 'FLAG{qr_error_correction_saves_lives}',
            ...
            [
                ...
                'description' => 'هاد السؤال فالدارجة المغربية. شنو هو الشيء لي كيدخل كبير وكيخرج صغير؟ الجواب هو FLAG{الجواب بالانجليزية}',
                'category'    => 'misc',
                'difficulty'  => 'insane',
                'points'      => 1000,
                'flag'        => 'FLAG{sharpener}',
